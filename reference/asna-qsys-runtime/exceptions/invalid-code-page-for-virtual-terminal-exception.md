...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) --> InvalidCodePageForVirtualTerminalException
...
| Name |  Description 
| --- | --- 
| **InvalidCodePageForVirtualTerminalException**(  ) | Empty constructor that sets the message to hard-coded text related to Code page 0 not being valid when starting interactive job without server support.
