...
| Name |  Description 
| --- | --- 
| **NetworkBlockingOutputException**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) ) | Constructor that takes *OUTPUT with no CacheWrites -filename- causing invalid Network Blocking exception.
...
```cs
NetworkBlockingOutputException( String FileName );
```
