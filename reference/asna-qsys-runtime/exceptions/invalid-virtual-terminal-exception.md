...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) --> InvalidVirtualTerminalException
...
```cs
InvalidVirtualTerminalException( ASNA.QSys.Runtime.VirtualTerminal mode );
```
