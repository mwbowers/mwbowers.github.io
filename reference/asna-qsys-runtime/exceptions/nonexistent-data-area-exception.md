...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) --> NonexistentDataAreaException
...
```cs
NonexistentDataAreaException( String name );
```
...
```cs
NonexistentDataAreaException( String name, Exception e );
```
