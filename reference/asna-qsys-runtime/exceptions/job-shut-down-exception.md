...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) --> [RuntimeException](/reference/asna-qsys-runtime/exceptions/runtime-exception.html) --> [EndOperationException](/reference/asna-qsys-runtime/exceptions/end-operation-exception.html) --> JobShutDownException
...
| Name |  Description 
| --- | --- 
| **JobShutDownException**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the JobShutDownException class.
...
```cs
JobShutDownException( String Message, Exception InnerException );
```
