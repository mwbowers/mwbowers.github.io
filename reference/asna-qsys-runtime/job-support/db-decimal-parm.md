...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [DBParm](/reference/asna-qsys-runtime/job-support/db-parm.html) --> [DBScaledParm](/reference/asna-qsys-runtime/job-support/db-scaled-parm.html) --> DBDecimalParm
