...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) --> [JobException](/reference/asna-qsys-runtime/job-support/job-exception.html) --> [CPF0000Exception](/reference/asna-qsys-runtime/job-support/cpf0000-exception.html) --> [CPF9800Exception](/reference/asna-qsys-runtime/job-support/cpf9800-exception.html) --> CPF9846Exception
