...
| Name |  Description 
| --- | --- 
| **CPFA094Exception**( [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the CPFA094Exception class.
...
```cs
CPFA094Exception( Exception innerException );
```
