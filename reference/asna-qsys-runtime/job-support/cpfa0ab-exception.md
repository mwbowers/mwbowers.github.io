...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) --> [JobException](/reference/asna-qsys-runtime/job-support/job-exception.html) --> [CPF0000Exception](/reference/asna-qsys-runtime/job-support/cpf0000-exception.html) --> [CPFA000Exception](/reference/asna-qsys-runtime/job-support/cpfa000-exception.html) --> CPFA0ABException
...
| Name |  Description 
| --- | --- 
| **CPFA0ABException**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the CPFA0ABException class.
...
```cs
CPFA0ABException( String objectName, Exception innerException );
```
