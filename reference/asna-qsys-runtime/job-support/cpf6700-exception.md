...
Defines the core behavior of CPF67xx exceptons.
...
| Name |  Description 
| --- | --- 
| **CPF6700Exception**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the CPF6700Exception class.
...
```cs
CPF6700Exception( String inner, Exception message );
```
