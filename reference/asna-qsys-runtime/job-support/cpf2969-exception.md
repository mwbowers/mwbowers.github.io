...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) --> [JobException](/reference/asna-qsys-runtime/job-support/job-exception.html) --> [CPF0000Exception](/reference/asna-qsys-runtime/job-support/cpf0000-exception.html) --> [CPF2900Exception](/reference/asna-qsys-runtime/job-support/cpf2900-exception.html) --> CPF2969Exception
