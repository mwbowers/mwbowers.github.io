...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Attribute](https://docs.microsoft.com/en-us/dotnet/api/system.attribute) --> DateTimeTypeAttribute
...
```cs
DateTimeTypeAttribute( Int32 kind, Int32 format, Int32 separator );
```
