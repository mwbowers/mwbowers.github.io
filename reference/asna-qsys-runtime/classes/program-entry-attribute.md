...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Attribute](https://docs.microsoft.com/en-us/dotnet/api/system.attribute) --> ProgramEntryAttribute
...
| Name |  Description 
| --- | --- 
| **ProgramEntryAttribute**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) ) | Initializes a ProgramEntryAttribute object.
...
```cs
ProgramEntryAttribute( String entryProcedureName );
```
...
| --- | --- | --- | --- 
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) | EntryProcedureName | Gets the name of *ENTRY in this class. | 
