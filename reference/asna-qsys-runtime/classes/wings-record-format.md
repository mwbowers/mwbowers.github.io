...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [UpdateWrfFile](#updatewrffilestring-xdocument)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [XDocument]($$TODO-Xml.Linq.XDocument.html)) | Sign the Wrf file and saves it to disk. | 
...
| [Dictionary{System.String,System.String}]($$TODO-Collections.Generic.Dictionary{System.String,System.String}.html) | formatLevelIds | The format name to format ID dictionary for the record formats in the file. 
...
[XDocument]($$TODO-Xml.Linq.XDocument.html)
...
```cs
LoadDataSet(Data.DataSet ds, String formatProps, ref Collections.Generic.Dictionary{System.String,System.String} responseIndTemplates, Boolean throwOnError);
```
...
| [Dictionary{System.String,System.String}]($$TODO-Collections.Generic.Dictionary{System.String,System.String}@.html) | responseIndTemplates | On exit, contains the response indicators for each record format, indexed by record format name. 
...
### UpdateWrfFile([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [XDocument]($$TODO-Xml.Linq.XDocument.html))
...
| --- | --- | ---
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) | displayFilePath | Path to the location where the Wrf file will be saved. 
| [XDocument]($$TODO-Xml.Linq.XDocument.html) | wrfDoc | XDocument containing the Wrf. 
