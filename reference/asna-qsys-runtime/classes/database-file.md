...
| Name |  Description 
| --- | --- 
| **DatabaseFile**( [Action](https://learn.microsoft.com/en-us/dotnet/api/system.action?view=net-8.0)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string),[AdgDataSet](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsAdgDataSetClass.htm)), [Action](https://learn.microsoft.com/en-us/dotnet/api/system.action?view=net-8.0)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string),[AdgDataSet](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsAdgDataSetClass.htm)), [Action](https://learn.microsoft.com/en-us/dotnet/api/system.action?view=net-8.0)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string),[AdgDataSet](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsAdgDataSetClass.htm),[String](https://docs.microsoft.com/en-us/dotnet/api/system.string)), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Dictionary]($$TODO-Dictionary.html)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string),[String](https://docs.microsoft.com/en-us/dotnet/api/system.string)), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32), [ShareTypes](https://docs.asna.com/documentation/Help170/DCS/_HTML/dcsFileOpenAttrClassShareTypesProperty.htm), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Action](https://learn.microsoft.com/en-us/dotnet/api/system.action?view=net-8.0) ) | Initializes a new instance of the DatabaseFile class.
...
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [AdgDataSet](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsAdgDataSetClass.htm), | populateFields | >Method that copies values from the dataset record to the program fields. 
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [AdgDataSet](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsAdgDataSetClass.htm), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), | populateBufferWithFields | Method that copies selected fields from the program to the dataset record. 
...
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), | formatIDs | Dictionary of format IDs keyed by format name.  Pass a null value unless level check is required.  Values (the formatID) are given as base64-encoded 20-byte strings. 
...
| [ShareTypes](https://docs.asna.com/documentation/Help170/DCS/_HTML/dcsFileOpenAttrClassShareTypesProperty.htm) | shareType | ShareTypes value that selects the type of file sharing. Default is ShareTypes.File. 
...
| [FileAdapter](/manuals/datagate/programmers-guide/usingthe-file-adapter-class.html) | fileAdapter | fileAdapter summary.<br>(Inherited from [DatabaseFileBase](/reference/asna-qsys-runtime/classes/database-file-base.html)) | 
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | InhibitWrites | Prevents operations to the file from actually updating it, effectively treating the operation as a no-op.<br>(Inherited from [DatabaseFileBase](/reference/asna-qsys-runtime/classes/database-file-base.html)) | 
...
| [AdgKeyTable](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsAdgKeyTableClassAdgKeyTableConstructor.htm) | Key | Gets or sets the main search key. | 
| [AdgKeyTable](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsAdgKeyTableClassAdgKeyTableConstructor.htm) | Kez | Gets or sets the secondary search key, used as the limit for range operations. | 
...
| --- | --- | --- | --- 
| [AdgDataSet](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsAdgDataSetClass.htm) | [allocateBuffer](#allocatebuffer)() | Allocates internal objects and constructs the file DataSet. | The newly created DataGate AdgDataSet.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [Check](#checkoutchar-object[])([Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Validate that a record exists. | True if the record is found, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [Delete](#deleteoutchar)([Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Delete the current record. | True if the record is found, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [Delete](#deleteoutchar-object[])([Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Delete the current record. | True if the record is found, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [DeleteRange](#deleterangeobject[]-object[]-rangefirst-rangelast)([Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [RangeFirst](/reference/datagate-client/range-first-enumeration.html), [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm)) | Delete a range of records. | True if records were found; false otherwise.
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [DeleteRange](#deleterangeobject[]-object[]-rangefirst-rangelast-outchar)([Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [RangeFirst](/reference/datagate-client/range-first-enumeration.html), [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Delete a range of records. | True if records were found; false otherwise.
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [DeleteRange](#deleterangeobject[]-object[]-rangefirst-rangelast-indicator)([Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [RangeFirst](/reference/datagate-client/range-first-enumeration.html), [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm), [Indicator](/reference/asna-qsys-runtime/classes/indicator.html)) | Delete a range of records. | True if records were found; false otherwise.
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Feod](#feodoutchar)([Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Force end of data on the current record. | 
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [open](/reference/asna-qsys-runtime/classes/database-file-base.html#open)([Database](/reference/asna-qsys-runtime/classes/database.html), [AccessMode](https://docs.asna.com/documentation/Help150/AVR/_HTML/AdgCommon_AccessMode.htm), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [ServerCursors](https://docs.asna.com/documentation/Help150/AVR/_HTML/AdgCommon_ServerCursors.htm)) | Open the database file.<br>(Inherited from [DatabaseFileBase](/reference/asna-qsys-runtime/classes/database-file-base.html)) | 
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Open](#opendatabase-accessmode-boolean-boolean-servercursors-indicator)([Database](/reference/asna-qsys-runtime/classes/database.html), [AccessMode](https://docs.asna.com/documentation/Help150/AVR/_HTML/AdgCommon_AccessMode.htm), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [ServerCursors](https://docs.asna.com/documentation/Help150/AVR/_HTML/AdgCommon_ServerCursors.htm), [Indicator](/reference/asna-qsys-runtime/classes/indicator.html)) | Open the database file. | 
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadNext](#readnextboolean-ids-outchar)([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [IDS](/reference/asna-qsys-runtime/classes/ids.html), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Read the next record sequentially. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadNextEqual](#readnextequalboolean-outchar-object[])([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read the next record sequentially, if it has the same key. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadNextEqual](#readnextequalboolean-ids-outchar-object[])([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [IDS](/reference/asna-qsys-runtime/classes/ids.html), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read the next record sequentially, if it has the same key. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadNextEqualIncompleteKey](#readnextequalincompletekeyboolean-outchar-string-object[])([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read sequentially a record with an incomplete key buffer. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadNextEqualIncompleteKey](#readnextequalincompletekeyboolean-ids-outchar-string-object[])([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [IDS](/reference/asna-qsys-runtime/classes/ids.html), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read sequentially a record with an incomplete key buffer. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadPrevious](#readpreviousboolean-ids-outchar)([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [IDS](/reference/asna-qsys-runtime/classes/ids.html), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Read the previous record sequentially. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadPreviousEqual](#readpreviousequalboolean-outchar-object[])([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read the previous record sequentially, if it has the same key. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadPreviousEqual](#readpreviousequalboolean-ids-outchar-object[])([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [IDS](/reference/asna-qsys-runtime/classes/ids.html), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read the previous record sequentially, if it has the same key. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadPreviousEqualIncompleteKey](#readpreviousequalincompletekeyboolean-outchar-string-object[])([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read the previous record sequentially, with an incomplete key buffer. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadPreviousEqualIncompleteKey](#readpreviousequalincompletekeyboolean-ids-outchar-string-object[])([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [IDS](/reference/asna-qsys-runtime/classes/ids.html), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read the previous record sequentially, with an incomplete key buffer. | True if End Of File condition is NOT reached, false otherwise.
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadPreviousEqualIncompleteKey](#readpreviousequalincompletekeyboolean-ids-indicator-string-object[])([Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [IDS](/reference/asna-qsys-runtime/classes/ids.html), [Indicator](/reference/asna-qsys-runtime/classes/indicator.html), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read the previous record sequentially, with an incomplete key buffer. | True if End Of File condition is NOT reached, false otherwise.
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadRange](#readrangeobject[]-object[]-rangemode-rangefirst-rangelast-boolean)([Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [RangeMode](https://docs.asna.com/documentation/Help170/DCS/_HTML/dcsRangeModeEnumeration.htm), [RangeFirst](/reference/datagate-client/range-first-enumeration.html), [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean)) | Read a range of records. | True if a record was found, false otherwise.
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadRange](#readrangeobject[]-object[]-rangemode-rangefirst-rangelast-boolean-outchar)([Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [RangeMode](https://docs.asna.com/documentation/Help170/DCS/_HTML/dcsRangeModeEnumeration.htm), [RangeFirst](/reference/datagate-client/range-first-enumeration.html), [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Read a range of records. | True if a record was found, false otherwise.
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Update](#updateoutchar)([Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Update a record. | 
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Update](#updateids-outchar)([IDS](/reference/asna-qsys-runtime/classes/ids.html), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Update a record. | 
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [UpdateFlds](#updatefldsoutchar-string[])([Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string)) | Update a record, only those fields listed. | 
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Write](#writeoutchar)([Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Write a record. | 
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Write](#writeids-outchar)([IDS](/reference/asna-qsys-runtime/classes/ids.html), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Write a record. | 
...
```cs
Chain(Boolean lockRecord, out Char err, Object[] keyParts);
```
...
```cs
Chain(Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
Chain(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out Char err, Object[] keyParts);
```
...
```cs
Chain(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
ChainByRRN(Boolean lockRecord, Int32 rrn, out Char err);
```
...
```cs
ChainByRRN(Boolean lockRecord, Int32 rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ChainByRRN(Boolean lockRecord, Decimal rrn, ASNA.QSys.Runtime.IDS intoDS, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ChainByRRN(Boolean lockRecord, Int32 rrn, ASNA.QSys.Runtime.IDS intoDS, out Char err);
```
...
```cs
ChainByRRN(Boolean lockRecord, Int32 rrn, ASNA.QSys.Runtime.IDS intoDS, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ChainByRRN(Boolean lockRecord, Decimal rrn, out Char err);
```
...
```cs
ChainByRRN(Boolean lockRecord, Decimal rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ChainByRRN(Boolean lockRecord, Decimal rrn, ASNA.QSys.Runtime.IDS intoDS, out Char err);
```
...
```cs
Check(out Char keyParts, Object[] err);
```
...
```cs
Check(out ASNA.QSys.Runtime.Indicator keyParts, Object[] err);
```
...
```cs
Delete(out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
Delete(out Char err, Object[] keyParts);
```
...
```cs
Delete(out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
DeleteByRRN(Int32 rrn, out Char err);
```
...
```cs
DeleteByRRN(Int32 rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
DeleteByRRN(Decimal rrn, out Char err);
```
...
```cs
DeleteByRRN(Decimal rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
### DeleteRange([Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [RangeFirst](/reference/datagate-client/range-first-enumeration.html), [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm))
...
| [RangeFirst](/reference/datagate-client/range-first-enumeration.html) | rangeFirstKey | RangeFirst value. 
| [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm) | rangeLastKey | RangeLast value. 
...
```cs
DeleteRange(Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, out Char err);
```
...
| [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) | firstKey | Array of key values for the first key. 
| [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) | lastKey | Array of key values for the last key. 
| [RangeFirst](/reference/datagate-client/range-first-enumeration.html) | rangeFirstKey | Initial include/exclude option. 
| [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm) | rangeLastKey | Last include/exclude option. 
| [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char) | err | Parameter that will be set to '1' or *ON if there was an error in the operation, '0' or *OFF otherwise. 
...
```cs
DeleteRange(Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
Feod(out ASNA.QSys.Runtime.Indicator err);
```
...
### Open([Database](/reference/asna-qsys-runtime/classes/database.html), [AccessMode](https://docs.asna.com/documentation/Help150/AVR/_HTML/AdgCommon_AccessMode.htm), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [ServerCursors](https://docs.asna.com/documentation/Help150/AVR/_HTML/AdgCommon_ServerCursors.htm), [Indicator](/reference/asna-qsys-runtime/classes/indicator.html))

Open the database file.

```cs
Open(ASNA.QSys.Runtime.Database database, ASNA.DataGate.Common.AccessMode accessMode, Boolean isCacheWrite, Boolean isCommit, ASNA.DataGate.Common.ServerCursors serverCursor, out ASNA.QSys.Runtime.Indicator err);
```
...
| [AccessMode](https://docs.asna.com/documentation/Help150/AVR/_HTML/AdgCommon_AccessMode.htm) | accessMode | AccessMode of the file. 
...
| [ServerCursors](https://docs.asna.com/documentation/Help150/AVR/_HTML/AdgCommon_ServerCursors.htm) | serverCursor | ServerCursors option value. 
| [Indicator](/reference/asna-qsys-runtime/classes/indicator.html) | err | Parameter that will be set to '1' or *ON if there was an error in the operation, '0' or *OFF otherwise. 
...
```cs
ReadNext(Boolean lockRecord, out Char err);
```
...
```cs
ReadNext(Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ReadNext(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out Char err);
```
...
```cs
ReadNext(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ReadNextEqual(Boolean lockRecord, out Char err, Object[] keyParts);
```
...
```cs
ReadNextEqual(Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
ReadNextEqual(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out Char err, Object[] keyParts);
```
...
```cs
ReadNextEqual(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
ReadNextEqualIncompleteKey(Boolean lockRecord, out Char err, String incompleteKey, Object[] keyParts);
```
...
```cs
ReadNextEqualIncompleteKey(Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err, String incompleteKey, Object[] keyParts);
```
...
```cs
ReadNextEqualIncompleteKey(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out Char err, String incompleteKey, Object[] keyParts);
```
...
```cs
ReadNextEqualIncompleteKey(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out ASNA.QSys.Runtime.Indicator err, String incompleteKey, Object[] keyParts);
```
...
```cs
ReadPrevious(Boolean lockRecord, out Char err);
```
...
```cs
ReadPrevious(Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ReadPrevious(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out Char err);
```
...
```cs
ReadPrevious(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ReadPreviousEqual(Boolean lockRecord, out Char err, Object[] keyParts);
```
...
```cs
ReadPreviousEqual(Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
ReadPreviousEqual(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out Char err, Object[] keyParts);
```
...
```cs
ReadPreviousEqual(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
ReadPreviousEqualIncompleteKey(Boolean lockRecord, out Char err, String incompleteKey, Object[] keyParts);
```
...
```cs
ReadPreviousEqualIncompleteKey(Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err, String incompleteKey, Object[] keyParts);
```
...
```cs
ReadPreviousEqualIncompleteKey(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out Char err, String incompleteKey, Object[] keyParts);
```
...
```cs
ReadPreviousEqualIncompleteKey(Boolean lockRecord, ASNA.QSys.Runtime.IDS intoDS, out ASNA.QSys.Runtime.Indicator err, String incompleteKey, Object[] keyParts);
```
...
| [RangeMode](https://docs.asna.com/documentation/Help170/DCS/_HTML/dcsRangeModeEnumeration.htm) | mode | Requested Range mode. 
| [RangeFirst](/reference/datagate-client/range-first-enumeration.html) | rangeFirstKey | Initial Exclude/Include option. 
| [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm) | rangeLastKey | Last Exclude/Include option. 
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | lockRecord | True to lock the record after the Read. 
...
```cs
ReadRange(Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeMode mode, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, Boolean lockRecord, out Char err);
```
...
```cs
ReadRange(Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeMode mode, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err);
```
...
### Seek([SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object))
...
| Type | Parameter name | Description
| --- | --- | ---
| [SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm) | mode | Seek mode. 
| [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) | keyParts | Collection of search keys. 
...
### Seek([SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object))

Positions the file cursor in the record indicated by key.

```cs
Seek(ASNA.DataGate.Common.SeekMode mode, out Char err, Object[] keyParts);
```
...
### Seek([SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Indicator](/reference/asna-qsys-runtime/classes/indicator.html), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object))

Positions the file cursor in the record indicated by key.

```cs
Seek(ASNA.DataGate.Common.SeekMode mode, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
### SeekByRRN([SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32))
...
### SeekByRRN([SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char))

Positions the file cursor in the record indicated by relative record number.

```cs
SeekByRRN(ASNA.DataGate.Common.SeekMode mode, Int32 rrn, out Char err);
```
...
### SeekByRRN([SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32), [Indicator](/reference/asna-qsys-runtime/classes/indicator.html))

Positions the file cursor in the record indicated by relative record number.

```cs
SeekByRRN(ASNA.DataGate.Common.SeekMode mode, Int32 rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
### SetRange([Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [RangeMode](https://docs.asna.com/documentation/Help170/DCS/_HTML/dcsRangeModeEnumeration.htm), [RangeFirst](/reference/datagate-client/range-first-enumeration.html), [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm))
...
| [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) | firstKey | Array of key values for the first key. 
| [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) | lastKey | Array of key values for the last key. 
| [RangeMode](https://docs.asna.com/documentation/Help170/DCS/_HTML/dcsRangeModeEnumeration.htm) | mode | RangeMode value. 
| [RangeFirst](/reference/datagate-client/range-first-enumeration.html) | rangeFirstKey | Include/Exclude initial search key option. 
| [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm) | rangeLastKey | Include/Exclude last search key option. 
...
```cs
SetRange(Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeMode mode, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, out Char err);
```
...
```cs
SetRange(Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeMode mode, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
Unlock(out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
Update(out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
Update(ASNA.QSys.Runtime.IDS fromDS, out Char err);
```
...
```cs
Update(ASNA.QSys.Runtime.IDS fromDS, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
UpdateFlds(out Char err, String[] fields);
```
...
```cs
UpdateFlds(out ASNA.QSys.Runtime.Indicator err, String[] fields);
```
...
```cs
Write(ASNA.QSys.Runtime.IDS fromDS, out Char err);
```
...
```cs
Write(ASNA.QSys.Runtime.IDS fromDS, out ASNA.QSys.Runtime.Indicator err);
```
