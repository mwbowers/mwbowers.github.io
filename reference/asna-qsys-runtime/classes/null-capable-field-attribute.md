...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Attribute](https://docs.microsoft.com/en-us/dotnet/api/system.attribute) --> NullCapableFieldAttribute
...
| Name |  Description 
| --- | --- 
| **NullCapableFieldAttribute**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) ) | Initializes a NullCapableFieldAttribute object.
...
```cs
NullCapableFieldAttribute( String funcName );
```
...
| --- | --- | --- | --- 
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) | FunctionName | Gets the name of the associated boolean field. | 
