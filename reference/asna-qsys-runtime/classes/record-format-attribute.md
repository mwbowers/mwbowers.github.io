...
| Name |  Description 
| --- | --- 
| **RecordFormatAttribute**( [String[]](https://docs.microsoft.com/en-us/dotnet/api/system.string), [String[][]]($$TODO-String[][].html) ) | Initializes a RecordFormatAttribute object. The attribute describes the records and fields in a database file.

<br>

### RecordFormatAttribute( [String[]](https://docs.microsoft.com/en-us/dotnet/api/system.string), [String[][]]($$TODO-String[][].html) )
...
| [String[][]]($$TODO-String[][].html) | fieldsInFormats | The field names in each record format. 
