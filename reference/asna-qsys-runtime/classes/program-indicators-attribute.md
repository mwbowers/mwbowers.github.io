...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Attribute](https://docs.microsoft.com/en-us/dotnet/api/system.attribute) --> ProgramIndicatorsAttribute
...
| --- | --- | --- | --- 
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) | INLRName | Name on *INLR in this class. | 
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) | INName | Name on *IN in this class. | 
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) | INRTName | Name on *INRT in this class. | 
