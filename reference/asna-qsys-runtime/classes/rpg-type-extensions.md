...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Convert](#convertdatetime)([DateTime](https://docs.microsoft.com/en-us/dotnet/api/system.datetime)) | Convert to IFixedSizeType. | The IFixedSizeType result.
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Convert](#convertstring)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string)) | Convert string to FixedSize string. | A new FixedSize string of the indicated length.
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [op_Addition](#op_additionfixeddecimal{`0-`1}-decimal)([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal)) | operator +. | Result of the operaration.
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [op_Equality](#op_equalityfixeddecimal{`0-`1}-decimal)([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal)) | operator ==. | Result of the operaration.
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [op_GreaterThan](#op_greaterthanfixeddecimal{`0-`1}-decimal)([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal)) | operator greater-than. | Result of the operaration.
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [op_GreaterThanOrEqual](#op_greaterthanorequalfixeddecimal{`0-`1}-decimal)([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal)) | operator greater-than or equals. | Result of the operaration.
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [op_Inequality](#op_inequalityfixeddecimal{`0-`1}-decimal)([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal)) | operator !=. | Result of the operaration.
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [op_LessThan](#op_lessthanfixeddecimal{`0-`1}-decimal)([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal)) | operator less-than. | Result of the operaration.
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [op_LessThanOrEqual](#op_lessthanorequalfixeddecimal{`0-`1}-decimal)([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal)) | operator less-than or equals. | Result of the operaration.
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [ToNumericString](#tonumericstring)() | Convert to numeric string. | The string result.
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [ToUpper](#toupper)() | Convert to string Uppercase. | The string result.
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Trim](#trim)() | Returns a new string in which all leading and trailing occurrences of a set of specified characters from the current string are removed. | The trimmed result.
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [TrimEnd](#trimend)() | The string that remains after all white-space characters are removed from the end of the current string. If no characters can be trimmed from the current instance, the method returns the current instance unchanged. | The trimmed result.
...
### op_Addition([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal))

operator +.

```cs
op_Addition(ASNA.QSys.Runtime.FixedDecimal{`0,`1} left, Decimal right);
```
...
| Type | Parameter name | Description
| --- | --- | ---
| [FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html) | left | Left hand operand. 
| [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal) | right | Right hand operand. 


<br>
<br>

### op_Equality([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal))

operator ==.

```cs
op_Equality(ASNA.QSys.Runtime.FixedDecimal{`0,`1} left, Decimal right);
```
...
### op_GreaterThan([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal))

operator greater-than.

```cs
op_GreaterThan(ASNA.QSys.Runtime.FixedDecimal{`0,`1} left, Decimal right);
```
...
### op_GreaterThanOrEqual([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal))

operator greater-than or equals.

```cs
op_GreaterThanOrEqual(ASNA.QSys.Runtime.FixedDecimal{`0,`1} left, Decimal right);
```
...
### op_Inequality([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal))

operator !=.

```cs
op_Inequality(ASNA.QSys.Runtime.FixedDecimal{`0,`1} left, Decimal right);
```
...
### op_LessThan([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal))

operator less-than.

```cs
op_LessThan(ASNA.QSys.Runtime.FixedDecimal{`0,`1} left, Decimal right);
```
...
### op_LessThanOrEqual([FixedDecimal{\\`0,\\`1}](/reference/asna-qsys-runtime/fixed-decimal{`0,`1}.html), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal))

operator less-than or equals.

```cs
op_LessThanOrEqual(ASNA.QSys.Runtime.FixedDecimal{`0,`1} left, Decimal right);
```
