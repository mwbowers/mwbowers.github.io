...
| Name |  Description 
| --- | --- 
| **RowAddedEventArgs**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) ) | Constructs a RowAddedEventArgs object that contains information about row added.
...
```cs
RowAddedEventArgs( String formatName );
```
