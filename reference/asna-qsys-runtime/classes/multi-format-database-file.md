...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [Delete](#deletestring-outchar)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Delete the current record. | True if the record was found, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [DeleteByRRN](#deletebyrrnstring-decimal-outchar)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Decimal](https://docs.microsoft.com/en-us/dotnet/api/system.decimal), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Delete a record using its relative record number. | True if the record found, otherwise false.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadNext](#readnextstring-boolean-outchar)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Read the next record sequentially. | True if End Of File condition is NOT reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadNextEqual](#readnextequalstring-boolean-outchar-object[])([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read the next record sequentially, if it has the same key. | True if NOT Eof of File condition reached, false otherwise.
...
| [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean) | [ReadPreviousEqual](#readpreviousequalstring-boolean-outchar-object[])([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Boolean](https://docs.microsoft.com/en-us/dotnet/api/system.boolean), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object)) | Read the previous record sequentially, if it has the same key. | True if NOT End of File condition is reached, otherwise false.
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [SetRange](#setrangestring-object[]-object[]-rangemode-rangefirst-rangelast-outchar)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object), [RangeMode](https://docs.asna.com/documentation/Help170/DCS/_HTML/dcsRangeModeEnumeration.htm), [RangeFirst](/reference/datagate-client/range-first-enumeration.html), [RangeLast](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsRangeLastEnumeration.htm), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Sets the range of records for input operations. | 
...
| [Void](https://docs.microsoft.com/en-us/dotnet/api/system.void) | [Write](#writestring-outchar)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char)) | Write a record given its record format name. | 
...
```cs
Chain(String formatName, Boolean lockRecord, out Char err, Object[] keyParts);
```
...
```cs
Chain(String formatName, Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
ChainByRRN(String formatName, Boolean lockRecord, Int32 rrn, out Char err);
```
...
```cs
ChainByRRN(String formatName, Boolean lockRecord, Int32 rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ChainByRRN(String formatName, Boolean lockRecord, Decimal rrn, out Char err);
```
...
```cs
ChainByRRN(String formatName, Boolean lockRecord, Decimal rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
Delete(String formatName, out Char err);
```
...
```cs
Delete(String formatName, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
Delete(String formatName, out Char err, Object[] keyParts);
```
...
```cs
Delete(String formatName, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
DeleteByRRN(String formatName, Int32 rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
DeleteByRRN(String formatName, Decimal rrn, out Char err);
```
...
```cs
DeleteByRRN(String formatName, Decimal rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
DeleteRange(String formatName, Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, out Char err);
```
...
```cs
DeleteRange(String formatName, Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ReadNext(String formatName, Boolean lockRecord, out Char err);
```
...
```cs
ReadNext(String formatName, Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ReadNextEqual(String formatName, Boolean lockRecord, out Char err, Object[] keyParts);
```
...
```cs
ReadNextEqual(String formatName, Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
ReadPrevious(String formatName, Boolean lockRecord, out Char err);
```
...
```cs
ReadPrevious(String formatName, Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
ReadPreviousEqual(String formatName, Boolean lockRecord, out Char keyParts, Object[] err);
```
...
```cs
ReadPreviousEqual(String formatName, Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
```cs
ReadRange(String formatName, Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeMode mode, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, Boolean lockRecord, out Char err);
```
...
```cs
ReadRange(String formatName, Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeMode mode, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, Boolean lockRecord, out ASNA.QSys.Runtime.Indicator err);
```
...
### Seek([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object))
...
### Seek([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object))

Positions the file cursor in the record indicated by key.

```cs
Seek(String formatName, ASNA.DataGate.Common.SeekMode mode, out Char err, Object[] keyParts);
```
...
### Seek([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Indicator](/reference/asna-qsys-runtime/classes/indicator.html), [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object))

Positions the file cursor in the record indicated by key.

```cs
Seek(String formatName, ASNA.DataGate.Common.SeekMode mode, out ASNA.QSys.Runtime.Indicator err, Object[] keyParts);
```
...
### SeekByRRN([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32))
...
### SeekByRRN([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32), [Char](https://docs.microsoft.com/en-us/dotnet/api/system.char))

Positions the file cursor in the record indicated by relative record number.

```cs
SeekByRRN(String formatName, ASNA.DataGate.Common.SeekMode mode, Int32 rrn, out Char err);
```
...
### SeekByRRN([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [SeekMode](https://docs.asna.com/documentation/Help160/DCS/_HTML/dcsSeekModeEnumeration.htm), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32), [Indicator](/reference/asna-qsys-runtime/classes/indicator.html))

Positions the file cursor in the record indicated by relative record number.

```cs
SeekByRRN(String formatName, ASNA.DataGate.Common.SeekMode mode, Int32 rrn, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
SetRange(String formatName, Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeMode mode, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, out Char err);
```
...
```cs
SetRange(String formatName, Object[] firstKey, Object[] lastKey, ASNA.DataGate.Common.RangeMode mode, ASNA.DataGate.Common.RangeFirst rangeFirstKey, ASNA.DataGate.Common.RangeLast rangeLastKey, out ASNA.QSys.Runtime.Indicator err);
```
...
```cs
Write(String formatName, out Char err);
```
