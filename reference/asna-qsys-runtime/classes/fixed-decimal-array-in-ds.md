...
| Name |  Description 
| --- | --- 
| **FixedDecimalArrayInDS**( [DataStructure](/reference/asna-qsys-runtime/asnaq-sys-runtime/classes/data-structure.html), [LayoutType](/reference/asna-qsys-runtime/asnaq-sys-runtime/classes/layout-type.html), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32), [Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32) ) | Constructs a fixed size array of FixedDecimal in a Data Structure.
...
```cs
FixedDecimalArrayInDS( ASNA.QSys.Runtime.DataStructure parent, ASNA.QSys.Runtime.LayoutType decimalType, Int32 startPos, Int32 skipPositions );
```
...
| --- | --- | ---
| [DataStructure](/reference/asna-qsys-runtime/asnaq-sys-runtime/classes/data-structure.html) | parent | The DataStructure containing this array of FixedDecimal. 
| [LayoutType](/reference/asna-qsys-runtime/asnaq-sys-runtime/classes/layout-type.html) | decimalType | The LayoutType describing the kind of fixed decimals, zoned, packed, or binary, the array contains. 
