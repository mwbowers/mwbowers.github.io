...
| --- | --- |
| [CreateJobConfig](#jobconfig-createjobconfigbatchentry-batchentry)([BatchEntry](https://learn.microsoft.com/en-us/dotnet/api/)) | Creates a JobConfig from a BatchEntry.
...
| [openDataConnections](#void-opendataconnectionsbatchentry-batchentry)([BatchEntry](https://learn.microsoft.com/en-us/dotnet/api/)) | New and populate a JobConfig from a BatchEntry
| [Setup](#void-setupbatchentry-batchentry)([BatchEntry](https://learn.microsoft.com/en-us/dotnet/api/)) | Setup a job with the options in the BatchEntry.

### JobConfig CreateJobConfig([BatchEntry batchEntry](https://learn.microsoft.com/en-us/dotnet/api/))
...
| --- | --- | ---
| [BatchEntry](https://learn.microsoft.com/en-us/dotnet/api/) | batchEntry | The input BatchEntry.
...
### void openDataConnections([BatchEntry batchEntry](https://learn.microsoft.com/en-us/dotnet/api/))
...
| Type | Parameter name | Description
| --- | --- | ---
| [BatchEntry](https://learn.microsoft.com/en-us/dotnet/api/) | batchEntry | The source BatchEntry

### void Setup([BatchEntry batchEntry](https://learn.microsoft.com/en-us/dotnet/api/))
...
| Type | Parameter name | Description
| --- | --- | ---
| [BatchEntry](https://learn.microsoft.com/en-us/dotnet/api/) | batchEntry | The BatchEntry with the options for the job.
