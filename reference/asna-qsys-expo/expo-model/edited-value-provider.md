...
### Filter([BindingSource](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.modelbinding.bindingsource))

Filters the value provider based on bindingSource.<br>(Inherited from [BindingSourceValueProvider](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.modelbinding.bindingsourcevalueprovider))
...
| Type | Parameter name | Description
| --- | --- | ---
| [BindingSource](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.modelbinding.bindingsource) | bindingSource | The BindingSource associated with a model. 

#### Returns

[IValueProvider]($$TODO-IValueProvider.html)
