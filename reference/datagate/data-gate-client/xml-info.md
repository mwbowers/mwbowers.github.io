...
|  | BeginWriteMembers | Looks up a localized string similar to Begin exporting file members.. |
...
|  | InvalidDataArea | Looks up a localized string similar to Data area definition import failed.. |
