...
| --- | --- | --- 
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AbandonMemberExport | Looks up a localized string similar to Cannot recover from data errors in this member.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AddDataOpenError | Looks up a localized string similar to Error opening or closing input file {0}; some or all records may not have been added to the file.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AddRecordBatchErrorCount | Looks up a localized string similar to Added unknown number of records from member {0} to {1} due to batch processing error.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AddRecordCount | Looks up a localized string similar to Added {0} records from member {1} to {2}.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AddRecordDataError | Looks up a localized string similar to Data error adding record {0} of member {1} to {2}.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AddRecordError | Looks up a localized string similar to Error adding record {0} of member {1} to {2}.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AddRecordErrorCount | Looks up a localized string similar to Unable to import {0} records.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AdgObjectAttrExportComplete | Looks up a localized string similar to AdgObject attributes export complete.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AdgObjectAttrImportComplete | Looks up a localized string similar to AdgObject attributes import complete.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AdgObjectContentExportComplete | Looks up a localized string similar to AdgObject content export complete.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | AdgObjectContentImportComplete | Looks up a localized string similar to AdgObject content import complete.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BasePathToAbsolutePath | Looks up a localized string similar to Converting base object paths to absolute paths.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BasePathToRelativePath | Looks up a localized string similar to Converting absolute base object paths to relative paths.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginReadBases | Looks up a localized string similar to Reading bases document.... |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginReadCreateAttr | Looks up a localized string similar to Importing print file creation attributes.... |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginReadDataAreaDef | Looks up a localized string similar to Reading data area definition.... |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginReadDbfCreateAttr | Looks up a localized string similar to Importing non-print file creation attributes.... |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginReadFileDef | Looks up a localized string similar to Reading file definition.... |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginReadRecords | Looks up a localized string similar to Adding imported records to the database.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginReadXml | Looks up a localized string similar to Beginning ReadXml with options=0x{0:x}.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginWriteBases | Looks up a localized string similar to Writing bases document.... |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginWriteCreateAttr | Looks up a localized string similar to Writing file creation attributes.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginWriteDataAreaDef | Looks up a localized string similar to Writing dataarea definition.... |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginWriteDir | Looks up a localized string similar to Begin exporting directory objects.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginWriteDirContent | Looks up a localized string similar to Enumerating directory contents.... |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginWriteFileDef | Looks up a localized string similar to Writing file definition.... |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginWriteMemberRecords | Looks up a localized string similar to Exporting records from the member.. |
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | BeginWriteMembers | Looks up a localized string similar to Begin exporting file members.. |
...
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | FileCreationFailure | Looks up a localized string similar to File {0} not created.. |
...
| [String](https://learn.microsoft.com/en-us/dotnet/api/system.string?view=net-8.0) | StarFirstMbrExport | Looks up a localized string similar to Chose to export *FIRST member ({0}).. |
