...
```cs
FormatMessage(String msgFilePath, Runtime.JobSupport.Message message);
```
...
```cs
FormatMessageText(String msgFilePath, Runtime.JobSupport.Message message, out String firstLevelText, out String secondLevelText);
```
