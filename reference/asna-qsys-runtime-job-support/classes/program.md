...
**Inheritance:** [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) --> [Module](/reference/asna-qsys-runtime-job-support/classes/module.html) --> [CommonProgram](/reference/asna-qsys-runtime-job-support/classes/common-program.html) --> Program
...
| [SQL_CommunicationsArea](/reference/asna-qsys-runtime-job-support/classes/sql-communications-area.html) | SQLCA | Gets the SQL communication area. It is populated AFTER (embedded) SQL command executes.<br>(Inherited from [Module](/reference/asna-qsys-runtime-job-support/classes/module.html)) | 
...
| --- | --- | --- | --- 
| [T](https://learn.microsoft.com/en-us/dotnet/standard/generics) | [BeginCall&lt;T&gt;](#begincall&lt;t&gt;icaller)([ICaller](/reference/asna-qsys-runtime/classes/i-caller.html)) | Prepares a program for execution by getting an instance of the program and pushing it in the invocation stack. | The prepared program instance.
...
| [Indicator](/reference/asna-qsys-runtime/classes/indicator.html) | [EndCall](#endcall)() | Marks the end of a program execution by popping it from the invocation stack and potentially deactivating it when the program's LR indicator is on. | The value of LR indicator.
...
| [Indicator](/reference/asna-qsys-runtime/classes/indicator.html) | [RunProgram&lt;T,U&gt;](#runprogram&lt;t,u&gt;icaller-func(<t>-<t>)-out``1)([ICaller](/reference/asna-qsys-runtime/classes/i-caller.html), [Func]($$TODO-Func.html)([&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/standard/generics),[&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/standard/generics)), [&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/standard/generics)) | Obtains an instance of a program and calls it. | The value of the LR Indicator on program return.
| [Indicator](/reference/asna-qsys-runtime/classes/indicator.html) | [RunProgram&lt;T&gt;](#runprogram&lt;t&gt;icaller-action<t>)([ICaller](/reference/asna-qsys-runtime/classes/i-caller.html), [Action&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/api/system.action-1?view=net-8.0)) | Obtains an instance of a program and calls it. | The value of the LR Indicator on program return.
...
| --- | --- | ---
| [ICaller](/reference/asna-qsys-runtime/classes/i-caller.html) | caller | The Program or Job preparing the program. 

#### Returns

[T](https://learn.microsoft.com/en-us/dotnet/standard/generics)

The prepared program instance.
...
[Indicator](/reference/asna-qsys-runtime/classes/indicator.html)
...
### RunProgram&lt;T,U&gt;([ICaller](/reference/asna-qsys-runtime/classes/i-caller.html), [Func]($$TODO-Func.html)([&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/standard/generics),[&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/standard/generics)), [&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/standard/generics))

Obtains an instance of a program and calls it.

```cs
RunProgram<T,U>(Runtime.ICaller _caller, Func(<T>, <T>) entry, out ``1 result);
```
...
| Type | Parameter name | Description
| --- | --- | ---
| [ICaller](/reference/asna-qsys-runtime/classes/i-caller.html) | _caller | The job or program seeking the service program instance. 
| [Func(&lt;T&gt;, &lt;T&gt;)](https://learn.microsoft.com/en-us/dotnet/api/system.func-2?view=net-8.0) | entry | The instance entrypoint method of the called program. 
| [&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/standard/generics) | result | The result of the program call. 

#### Returns

[Indicator](/reference/asna-qsys-runtime/classes/indicator.html)

The value of the LR Indicator on program return.


<br>
<br>

### RunProgram&lt;T&gt;([ICaller](/reference/asna-qsys-runtime/classes/i-caller.html), [Action&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/api/system.action-1?view=net-8.0))

Obtains an instance of a program and calls it.

```cs
RunProgram<T>(Runtime.ICaller _caller, Action<T> entry);
```
...
| --- | --- | ---
| [ICaller](/reference/asna-qsys-runtime/classes/i-caller.html) | _caller | The job or program seeking the service program instance. 
| [Action&lt;T&gt;](https://learn.microsoft.com/en-us/dotnet/api/system.action-1?view=net-8.0) | entry | The instance entrypoint method of the called program. 
