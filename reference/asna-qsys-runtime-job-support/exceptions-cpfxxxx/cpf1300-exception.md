...
| Name |  Description 
| --- | --- 
| **CPF1300Exception**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the CPF1300Exception class.
...
```cs
CPF1300Exception( String inner, Exception message );
```
