...
| Name |  Description 
| --- | --- 
| **CPF2696Exception**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the CPF2696Exception class.
...
```cs
CPF2696Exception( String obj, String type, Exception innerException );
```
