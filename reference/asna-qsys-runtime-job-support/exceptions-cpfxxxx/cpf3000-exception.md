...
| Name |  Description 
| --- | --- 
| **CPF3000Exception**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the CPF3000Exception class.
...
```cs
CPF3000Exception( String inner, Exception message );
```
