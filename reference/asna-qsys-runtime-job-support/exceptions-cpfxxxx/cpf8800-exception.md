...
| Name |  Description 
| --- | --- 
| **CPF8800Exception**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the CPF8800Exception class.
...
```cs
CPF8800Exception( String inner, Exception message );
```
