...
| Name |  Description 
| --- | --- 
| **CPF7000Exception**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the CPF7000Exception class.
...
```cs
CPF7000Exception( String inner, Exception message );
```
