...
| Name |  Description 
| --- | --- 
| **CPF3492Exception**( [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) ) | Initializes a new instance of the CPF3492Exception class.
...
```cs
CPF3492Exception( String filePath, Exception innerException );
```
